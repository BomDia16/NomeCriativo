...
<html lang="pt-br">
    ...
    <meta charset="utf-8">
        ...
        <!-- Title / Icon -->
        <title>nomeCriativo - Ingresso-edit</title>
                ...
                <div class="carta" style="width: 100%;">
                    <div class="card">
                        ...
                        <div class="card-image waves-effect waves-block waves-light">
                            <form action="{{ route('ingresso.update', $ingressos->id) }}" method="post">
                                @csrf
                                @method('put')
                                <!-- Titulo -->
                                <div class="input-field col s6">
                                    <input name="titulo" type="text" id="titulo" value="{{ $ingressos->titulo }}" class="validate @error('titulo') is-invalid @enderror">
                                ...
                                <!-- descricao -->
                                <div class="input-field col s6">
                                    <input name="descricao" id="descricao" value="{{ $ingressos->descricao }}" type="text" class="validate @error('descricao') is-invalid @enderror">
                                ...
                                <!-- imagem -->
                                <div class="input-field col s6">
                                    <input name="imagem" id="imagem" type="text" value="{{ $ingressos->imagem }}" class="validate @error('imagem') is-invalid @enderror">
                                ...
                                <!-- preco -->
                                <div class="input-field col s6">
                                    <input name="preco" id="preco" type="text" value="{{ $ingressos->preco }}" class="validate @error('preco') is-invalid @enderror">
                                ...
                                <div class="input-field col s12">
                                    <select name="tipoIngresso">
                                        @forelse($tipoIngressos as $tipoIngresso)
                                            <option class="black-text" name="tipoIngresso" value="{{ $tipoIngresso->id }}" <?= $ingressos->tipoIngresso == $tipoIngresso->id ? 'selected' : '' ?>>{{ $tipoIngresso->nome }}</option>
                                        @empty
                                        @endforelse
                                    </select>
