...
<html lang="pt-br">
    ...
    <meta charset="utf-8">
        ...
        <!-- Title / Icon -->
        <title>nomeCriativo - Lista Ingressos</title>
                        ...
                        <div class="card-image waves-effect waves-block waves-light">
                            <table class="striped responsive-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>{{ $ingresso->id }}</th>
                                        <th><img src="{{ $ingresso->imagem }}"></th>
                                        <th>{{ $ingresso->titulo }}</th>
                                        <th>{{ $ingresso->descricao }}</th>
                                        <th>R${{ $ingresso->preco }},00</th>
                                        <th>
                                            <button class="btn waves-effect waves-light blue-grey darken-3">
                                                <a class="white-text" href="{{ route('ingresso.edit', $ingresso->id) }}">
                                        ...
                                        <th>
                                            <form action="{{ route('ingresso.destroy', $ingresso->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
