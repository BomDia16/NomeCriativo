...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>nomeCriativo</title>
        <link href="https://i.pinimg.com/736x/2e/d5/7a/2ed57accf63d08e5ebb1ee853bed1832.jpg" rel="icon">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <a href="{{ route('view.login') }}" class="text-sm text-gray-700 underline">Login</a>
                    <a href="{{ route('view.login-admin') }}" class="text-sm text-gray-700 underline">Admin</a>
                </div>
            ...
            <div class="card-panel grey lighten-3" style="width: 50%;">
                ...
                <h2>Bem vindo ao nomeCriativo, para começar a compra dos seus ingressos por favor faça o seu login</h2>
            </div>
        </div>
    </body>
</html>
